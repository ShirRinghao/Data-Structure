...
int main() {
  ...
  std::cout << "An empty vector is a heap.  check_heap = " << pq_int.check_heap(empty_vector) << std::endl;
  std::cout << "A one-element vector is also a heap.  check_heap = "  
            << pq_int.check_heap(one_vector) << std::endl;
  std::cout << "A manually constructed heap.  check_heap = " << pq_int.check_heap(heap_vector) << std::endl;
  std::cout << "A change at one location creates a non-heap.  check_heap = " 
  ...
  std::cout << "The top, which should be 3, is " << pq_int.top() << std::endl;
  std::cout << "The call to pq.int.empty() returns " << pq_int.empty() << std::endl;
  std::cout << "pq_int.check_heap() = " << pq_int.check_heap() << std::endl;
